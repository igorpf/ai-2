...
class Controller:
    ...
    # TODO: carrega a tabela Q de um arquivo (se load!=None, entao load irá conter o nome do arquivo a ser carregado), 
	...
	def save_table_Q(self, episode, state):
		#Escrever nesse arquivo que está sendo criado na pasta params
	...
	# Recebe como o parametro a acao executada, o estado anterior e posterior à execucao dessa acao,
	# o numero de passos desde o inicio do episodio, e um booleano indicando se o episódio acabou apos a execucao da acao.
	...
	# Recebe como o parametro a acao executada, o estado anterior e posterior à execucao dessa acao,
	# a recompensa obtida e um booleano indicando se o episódio acabou apos a execucao da acao
